...
This is a working list, not an approval or a completed package. Keep the existing Devpost draft. Registration is already recorded; do not register again.
...
Do not replace pending links with made-up URLs or turn local receipts into public testnet claims. The contract has no independent security audit and is not intended for real funds.
